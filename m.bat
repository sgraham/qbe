...
call "cl.exe" ^
    /nologo /Zi /W4 /WX abi.c alias.c cfg.c copy.c emit.c fold.c getopt.c live.c load.c main.c mem.c parse.c rega.c simpl.c spill.c ssa.c util.c ^
    ...
    /link /out:qbe.exe || exit /b

call python tools/test.py
